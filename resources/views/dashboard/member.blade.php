    ...
    <div class="col-12">
        <div class="card shadow-sm" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); border: none;">
            <div class="card-body text-white">
                <div class="row">
                    {{-- First Column: Referral Network --}}
                    <div class="col-md-6 mb-3 mb-md-0 text-center">
                                <p class="mb-1 small" style="color: rgba(255,255,255,0.9);">
                    ...
                    <div class="col-md-6" style="text-align: center;">
                        @isset($joinDate)
                        <p class="mb-1 small" style="color: rgba(255,255,255,0.9);">
                            Joined Since: <strong>{{ $joinDate->format('M d, Y') }}</strong>
                        </p>
                        @endisset

                        @isset($sponsorName)
                        <p class="mb-1 small" style="color: rgba(255,255,255,0.9);">
                            Referred by: <strong>{{ $sponsorName }}</strong>
                        </p>
                        @endisset
...
<a href="#" data-toggle="modal" data-target="#cashinModal" class="text-decoration-none text-dark" style="flex: 0 0 30%;">
    ...
    {{-- Request Code --}}
    <a href="{{ route('member.membership-code-request.create') }}" class="text-decoration-none text-dark" style="flex: 0 0 30%;">
        <div class="card shadow-sm p-3">
             <i class="bi bi-upc-scan fa-2x text-warning mb-2"></i>
            <div class="small">Request Code</div>
        </div>
    </a>
